...
if (foundEntities.length > 0) {
  console.log(`MikroORM: loaded ${foundEntities.length} entity classes from ${candidateDir}`);
} else {
  console.log('MikroORM: no entity classes loaded from', candidateDir, '— falling back to globs');
}
